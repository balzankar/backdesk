...
<?php
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
       ...
       $query  .=" buy_price ='{$p_buy}', sale_price ='{$p_sale}', categorie_id ='{$p_cat}',manu='{$p_manu}',media_id='{$media_id}'";
                ...
                <div class="row">
                  <div class="col-md-4"><label for="qty">Select Category</label>
                   ...
                   <?php endforeach; ?>
                    ...
                    <div class="col-md-4"><label for="qty">Manufracturer</label>
                  ...
                  <div class="col-md-4"><label for="qty">Product Image</label>
